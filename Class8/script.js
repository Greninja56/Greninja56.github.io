...
if (searchInput) {
  ...
  searchInput.addEventListener('input', () => {
    filterPlayers();
    saveWithExpiration('searchValue', searchInput.value); // refresh timestamp
  });
}
if (roleFilter) {
  ...
  roleFilter.addEventListener('change', () => {
    filterPlayers();
    saveWithExpiration('roleValue', roleFilter.value); // refresh timestamp
  });
}
if (teamFilter) {
  ...
  teamFilter.addEventListener('change', () => {
    filterPlayers();
    saveWithExpiration('teamValue', teamFilter.value); // refresh timestamp
  });
}
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  themeToggleBtn?.addEventListener('click', () => {
    ...
    saveWithExpiration('userTheme', newTheme); // refresh timestamp
